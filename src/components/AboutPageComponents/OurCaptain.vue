<template>
  <section class="max-w-7xl mx-auto md:px-8 py-24 text-center">
    ...
    >
      ...
      <div class="text-left">
        ...
        <p class="text-sm md:text-lg text-slate-500 leading-relaxed italic">
          ...
          platform that puts people first. Eli&apos;s strategic mindset,
          dedication to transparency, and commitment to excellence continue to
          shape the company&apos;s culture and long-term success. His leadership
          inspires the team to constantly improve, embrace new ideas, and
          deliver seamless ticketing solutions that customers can trust.”
        </p>
      </div>
    </div>
  </section>
